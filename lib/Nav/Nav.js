...
var Nav = function (_React$PureComponent) {
  ...
  function Nav(props) {
    ...
    _this.state = { desktopScrollNav: false };
  ...
  _createClass(Nav, [{
    ...
    value: function onScrollDesktop(evt) {
      ...
      var scrolledPastBuffer = navHeight * 3 < evt.target.body.scrollTop;
    ...
    value: function onScrollMobile(evt) {
      // Visible when scrolling up and we have scrolled past
      // 5 * nav height
      var navHeight = this.mobileNav && this.mobileNav.offsetHeight || 0;
      var scrolledPastBuffer = navHeight * 5 < evt.target.body.scrollTop;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.mobileScrollNav && _react2.default.createElement(
            _NavMobile2.default,
            {
              className: 'scroll',
              logo: this.props.logo,
