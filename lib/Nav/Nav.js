...
var StyledDiv = _Div2.default.extend(_templateObject3);
  ...
  _createClass(Nav, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(StyledDiv, null),
        _react2.default.createElement(
          _NavMobile2.default,
          {
            className: (0, _classnames2.default)({ visible: this.state.mobileNavVisible }),
            logo: this.props.logo,
            navRef: function navRef(x) {
