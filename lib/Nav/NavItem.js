...
_react2.default.createElement(StyledDiv,{className:className,small:small,__source:{fileName:_jsxFileName,lineNumber:28}},
_react2.default.cloneElement(
link,
{className:'link'},
_react2.default.createElement(_Wrapper.Activatable,{active:active,__source:{fileName:_jsxFileName,lineNumber:32}},
_react2.default.createElement(_IconWithText2.default,{icon:icon,text:text,textPosition:textPosition,__source:{fileName:_jsxFileName,lineNumber:33}})))));};
