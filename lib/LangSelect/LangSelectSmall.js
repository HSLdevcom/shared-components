...
var Div = _styledComponents2.default.div(_templateObject, _LangButton2.default);
...
exports.default = (0, _styledComponents2.default)(LangSelectSmall)(_templateObject3, function (props) {
  return props.theme.background && 'background: ' + props.theme.background + ';';
});