...
exports.LangSelectSmall = undefined;
...
var Div = _styledComponents2.default.div(_templateObject4, LangButton);

var LangSelectSmallUnstyled = function LangSelectSmallUnstyled(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_Icons.ArrowDown, { height: '0.75rem', width: '0.75rem', fill: fill })
    ),
    open && languages.filter(function (lang) {
      return lang.id !== selectedLanguage;
    }).map(function (lang) {
      return _react2.default.createElement(
        LangButton,
...
var LangSelectSmall = (0, _styledComponents2.default)(LangSelectSmallUnstyled)(_templateObject5, function (props) {
  return props.theme.background && 'background-color: ' + props.theme.background + ';';
});

exports.LangSelectSmall = LangSelectSmall;