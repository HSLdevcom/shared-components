...
var Arrow = _react2.default.createElement(_Icons.ArrowDown, { height: '0.5rem', width: '0.75rem' });

var StyledDiv = _Div2.default.extend(_templateObject, _Nav.NavItem, _Button.ButtonNoStyle, _Span2.default, function (props) {
  return props.open && '\n      #arrow {\n        transform: rotate(-180deg);\n      }\n    ';
}, _DropdownContainerMobile2.default, function (props) {
  return props.theme.Media && props.theme.Media.small(_templateObject2, _DropdownContainerDesktop2.default, _DropdownContainerMobile2.default, props.open && 'background-color: ' + props.theme.primaryText + ';', props.open && 'color: ' + props.theme.primary + ';', _Button.ButtonNoStyle, props.open && 'border-bottom: 1px solid #cccccc;');
});
