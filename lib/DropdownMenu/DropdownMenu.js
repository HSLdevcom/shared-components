...
var StyledDiv = _Div2.default.extend(_templateObject, _DropdownContainerMobile2.default, function (props) {
  return props.theme.Media && props.theme.Media.small(_templateObject2, _DropdownContainerDesktop2.default, _DropdownContainerMobile2.default, _Button.ButtonNoStyle, props.open && 'background-color: ' + props.theme.primaryText + ';', props.open && 'color: ' + props.theme.primary + ';', _Button.ButtonNoStyle, props.open && 'border-bottom: 1px solid #cccccc;');
});
