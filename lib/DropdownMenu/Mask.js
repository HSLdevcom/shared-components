...
var Mask = function (_React$PureComponent) {
  ...
  _createClass(Mask, [{
    ...
    value: function onResize() {
      ...
      this.setState({
        height: document.body.scrollHeight - this.mask.getBoundingClientRect().top - window.pageYOffset
      });
    }
  }, {
    key: 'render',
...
exports.default = (0, _styledComponents2.default)(Mask)(_templateObject2);