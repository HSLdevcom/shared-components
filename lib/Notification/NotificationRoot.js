...
var NotificationBar = _UltraWideContainer2.default.extend(_templateObject, _2.Span);
...
var NotificationRoot = function (_Component) {
  ...
  _createClass(NotificationRoot, [{
    ...
    key: 'clearPreviousNotification',
    value: function clearPreviousNotification() {
    ...
    value: function renderCloseButton(notification) {
      return _react2.default.createElement(
        _2.Div,
        { className: 'close-button' },
        _react2.default.createElement(
          'button',
          { onClick: this.cleanWithAnimation },
