...
var Button = _styledComponents2.default.button(_templateObject, function (props) {
  ...
  return props.primary && '\n    border-color: ' + props.theme.primary + ';\n    background-color: ' + props.theme.primary + ';\n    color: ' + props.theme.primaryText + ';\n    &:hover {\n      border-color: ' + (0, _polished.darken)(0.1, props.theme.primary) + ';\n      background-color: ' + (0, _polished.darken)(0.1, props.theme.primary) + ';\n    }\n  ';
}, function (props) {
  return props.secondary && '\n    border-color: ' + (0, _polished.darken)(0.2, props.theme.default) + ';\n    color: ' + (0, _polished.darken)(0.2, props.theme.default) + ';\n    &:hover {\n      border-color: ' + props.theme.primary + ';\n    }\n  ';
}, function (props) {
  return props.disabled && '\n    color: ' + props.theme.default + ';\n    border-color: ' + props.theme.default + ';\n    &:hover {\n      border-color: ' + props.theme.default + ';\n    }\n  ';
}, function (props) {
  return props.disabled && props.primary && '\n    background-color: ' + (0, _polished.lighten)(0.175, props.theme.default) + ';\n    border-color: ' + (0, _polished.lighten)(0.175, props.theme.default) + ';;\n    &:hover {\n      background-color: ' + (0, _polished.lighten)(0.175, props.theme.default) + ';;\n      border-color: ' + (0, _polished.lighten)(0.175, props.theme.default) + ';;\n    }\n  ';
});
