...
var StyledFlex = _Wrapper.Flex.extend(_templateObject, _LangSelect.LangSelectSmall, function (props) {
...
}, _MenuItem2.default, function (props) {
  return props.theme.Media && props.theme.Media.medium(_templateObject2);
});
