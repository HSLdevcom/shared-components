...
}, Width.large, function (props) {
  return props.theme.Media && props.theme.Media.large(_templateObject2, Width.medium, _Separator.MenuSeparator);
}, function (props) {
  return props.theme.Media && props.theme.Media.medium(_templateObject3, Width.small);
});
...
var Menu = function Menu(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _Wrapper.Flex,
      { className: 'top' },
      _react2.default.createElement(_Icons.Search, { height: '1.5rem', width: '1.5rem' }),
      _react2.default.createElement(
        _Span2.default,
