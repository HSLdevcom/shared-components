'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/Menu/MenuItem.js';var _templateObject=_taggedTemplateLiteral(['\n  display: flex;\n  >.link {\n    display: flex;\n  }\n  ',' {\n    .text {\n      ','\n    }\n  }\n'],['\n  display: flex;\n  >.link {\n    display: flex;\n  }\n  ',' {\n    .text {\n      ','\n    }\n  }\n']),_templateObject2=_taggedTemplateLiteral([''],['']);var _react=require('react');var _react2=_interopRequireDefault(_react);
...
var MenuItem=function MenuItem(_ref){var
link=_ref.link,
icon=_ref.icon,
text=_ref.text,
...
link,
{className:'link'},
_react2.default.createElement(_Wrapper.Activatable,{active:active,small:small,__source:{fileName:_jsxFileName,lineNumber:36}},
...
(0,_styledComponents2.default)(MenuItem)(_templateObject2);