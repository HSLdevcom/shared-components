...
var StyledDiv = _Div2.default.extend(_templateObject2, Header, function (props) {
  return props.theme.Media && props.theme.Media.small(_templateObject3);
}, Ul, function (props) {
  return props.theme.Media && props.theme.Media.large(_templateObject4);
}, function (props) {
  return props.theme.listItemMarker;
}, function (props) {
  return props.theme.Media && props.theme.Media.small(_templateObject5);
});
